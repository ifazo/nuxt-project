<template>
  <div>
    <div v-if="user" class="divide-y divide-gray-200">
      <div class="pb-6">
          ...
          <div>
            <div class="-m-1 flex">
              ...
              >
                ...
                <div v-else>
                  <UserCircleIcon
                    class="h-24 w-24 flex-shrink-0 text-gray-400 sm:h-40 sm:w-40 lg:h-48 lg:w-48"
                    aria-hidden="true"
                  />
                </div>
              </div>
            ...
            <div class="mt-6 sm:ml-6 sm:flex-1">
              ...
              >
                <button
                  type="button"
                  class="inline-flex w-full flex-shrink-0 items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:flex-1"
                >
                  Message
                </button>
                <button
        ...
        <div class="px-4 py-5 sm:px-0 sm:py-0">
          <dl class="space-y-8 sm:space-y-0 sm:divide-y sm:divide-gray-200">
            <div class="sm:flex sm:px-6 sm:py-5">
              ...
              >
                <p>I'm {{ user.name }}, a consumer of this platform.</p>
              </dd>
            </div>
            <div class="sm:flex sm:px-6 sm:py-5">
              <dt
...
definePageMeta({
  layout: "dashboard",
  middleware: async function (user) {

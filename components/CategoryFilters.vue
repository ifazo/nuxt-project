    ...
    <div>
      ...
      <main class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <div class="border-b border-gray-200 pb-10">
          <h1 class="text-2xl font-bold tracking-tight text-gray-900">Product List</h1>
          <p class="mt-4 text-xl font-semibold text-gray-500">Discover our latest products and collections.</p>
        </div>
